      ...
      <form>
        <div className='my-4 md:flex items-center gap-6'>
          <div className=' md:flex-1'>
            ...
            <select defaultValue="Pick a color" className="select w-full" required>
          ...
          <div className='md:flex-1'>
            <label className="fieldset-label pb-2">Job Field/Title</label>
            <select defaultValue="Pick a color" className="select w-full" required>
        ...
        <div className='my-4 md:flex items-center gap-6'>
          <div className='md:flex-1'>
            ...
            <input type="text" className="input w-full" name='location' placeholder="Enter you location" required />
          </div>
          <div className='md:flex-1'>
        ...
        <div className='mb-5'>
          ...
          <input type="date" className="input w-full" name='applicationDeadline' placeholder="Email" required />
        </div>
        {/* 4 step */}
        ...
        <div className='mb-5 md:flex items-center gap-4'>
          <div className='md:flex-1'>
            ...
            <input type="text" className="input" placeholder="min" required />
          </div>
          <div className='md:flex-1'>
            <label className="fieldset-label pb-2">Max</label>
            <input type="text" className="input" placeholder="max" required />
          </div>
          <div className='md:flex-1'>
        ...
        <div className='my-5'>
          ...
          <input type="text" className="input w-full" name='company' placeholder="Enter you company name" required />
        </div>
        {/* 7 step */}
        <div className='my-5'>
        ...
        <div className='my-5'>
          ...
          <select defaultValue="active" className="select w-full" required>
        ...
        <div className='md:flex items-center my-5 gap-5'>
          <div className='md:flex-1'>
            ...
            <input type="text" className="input w-full" name='hr_name' placeholder="Enter hr name" required />
          </div>
          <div className='md:flex-1'>
            <label className="fieldset-label pb-2">HR Email</label>
            <input type="email" className="input w-full" name='hr_email' placeholder="Enter hr email" required />
          </div>
        </div>
        {/* Final company logo */}
        <div className='mb-5 md:mb-10'>
          <label className="fieldset-label pb-2">Company Logo</label>
          <input type="url" className="input w-full" name='company_log' placeholder="Enter company logo" required />
        </div>
        {/* Submit button */}
